...
PointCloud<PointXYZRGB>::Ptr src, tgt;
                 ...
                 PointCloud<Normal> &normals_tgt)
{
  ...
  copyPointCloud<PointXYZRGB, PointNormal> (*src, s);
  copyPointCloud<Normal, PointNormal> (normals_src, s);
  copyPointCloud<PointXYZRGB, PointNormal> (*tgt, t);
                       ...
                       Eigen::Matrix4f &transform)
{
  ...
  /*PointCloud<PointNormal> s, t;
  pcl::copyPointCloud<PointXYZ, PointNormal> (*keypoints_src, s);
  pcl::copyPointCloud<Normal, PointNormal> (normals_src, s);
  pcl::copyPointCloud<PointXYZ, PointNormal> (*keypoints_tgt, t);
