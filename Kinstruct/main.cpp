...
//  std::cerr << "PointCloud before filtering: " << global->width * global->height 
//       << " data points (" << pcl::getFieldsList (*global) << ").";
//  pcl::VoxelGrid<pcl::PointXYZRGB> sor;
//  sor.setInputCloud (global);
//  sor.setLeafSize (0.005f, 0.005f, 0.005f);
//  sor.filter (*downsampled);
//  refineSurface(downsampled);
//  pass.setInputCloud(downsampled);
//  global->clear();
//  pass.filter(*global);
//  std::cerr << "PointCloud after filtering: " << global->width * global->height 
//       << " data points (" << pcl::getFieldsList (*global) << ").";
